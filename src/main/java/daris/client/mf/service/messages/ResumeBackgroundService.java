...
public class ResumeBackgroundService extends ObjectMessage<Void> {

    private long _id;

    public ResumeBackgroundService(BackgroundService bs) {
        this(bs.id());
    }

    public ResumeBackgroundService(long id) {
        _id = id;
    }
    ...
    protected String messageServiceName() {
        return "service.background.resume";
    }
